...
,s
ls
sudo nano start-rtlinux.sh 
cat /sys/devices/system/cpu/cpufreq/policy1/scaling_max_freq
sudo nano start-rtlinux.sh 
git add -A
git commit -m "cpu scaling policy fixed typo for dual-core"
git push
cat /nohup.out 
rm /nohup.out 
shutdown -h now
...
mount -t gpt /dev/sdb /media/usb
mount -t ext4 /dev/sdb2 /media/usb
mount -t ext4 /dev/sdb3 /media/usb
cd /media/usb
ls
cd boot
ls
...
ls
ls /boot
mkdir /media/usb_grub
mount /dev/sdb2 /media/usb_grub/
mount /dev/sdb1 /media/usb_grub/
cd /media/usb_grub/
ls
cd EFI
ls
