...
cd /rootr/Claymore
nohup taskset -c 2 /rootr/Claymore/ethdcrminer64 -epool local.ethermine.org:8008 -ewal 0x9eaba219ac4ac28c2c008b3d9968cdbb7c5250f0.rig1 -epsw x \
...
-ftime 10 -tstop 85 -tt 55 -fanmin 60 -fanmax 100 -cclock 1150 -mclock 2200 -cvddc 900 -mvddc 900 -asm 1 -dcri 17 -ethi 16 -wd 0 -erate 0 -logsmaxsize 0 &
