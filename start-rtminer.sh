...
nohup python /rootr/Claymore/stratum_proxy.py --local-host 1.2.3.4 --local-port 8008 --remote-host daggerhashimoto.usa.nicehash.com --remote-port 3353 --wallet-address 3NktvtucrCFRDdNi8aHiA9ozpYDnKZxDkJ.Denizen & 
