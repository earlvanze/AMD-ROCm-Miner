...
-cclock 1100 -cvddc 900 \	# core clock and voltage settings
-mclock 2200 -mvddc 900		# memory clock and voltage settings
sleep 3600			# waits an hour
killall ethdcrminer64		# kills existing process to restart Claymore
done) &
...
#while sleep 3611; do reboot; done&		# this doesn't seem to run
